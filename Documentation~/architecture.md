...
| [XR_FB_eye_tracking_social](https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#XR_FB_eye_tracking_social) | [Social Eye Gaze](xref:meta-openxr-social-eye-gaze) | This extension exposes per-eye gaze direction for use in social presence applications, such as animating avatar eye bones to reflect where the user is looking. |
...
| [XR_META_boundary_visibility](https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#XR_META_boundary_visibility) | [Boundary visibility](xref:meta-openxr-boundary-visibility) | This extension enables you to suppress the visibility of the boundary so users can move freely with Passthrough enabled. |
...
| [XR_META_environment_raycast](https://registry.khronos.org/OpenXR/specs/1.1/html/xrspec.html#XR_META_environment_raycast)| [Ray casts](xref:meta-openxr-raycasts) | This extension enables you to perform raycast operations against the surrounding physical environment. |
